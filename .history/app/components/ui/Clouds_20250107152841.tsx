  ...
  return (
    <div className="absolute top-[-45%] left-[50%] w-[78rem] -translate-x-1/2 aspect-square">
      ...
      <Image
        ...
        className="relative"
        style={{
          left: `calc(0% + ${cloudsPosition.cloud1.x}px)`,
          top: `calc(10% + ${cloudsPosition.cloud1.y}px)`,
          width: "350px", // Make the cloud smaller
      ...
      <Image
        ...
        style={{
          ...
          top: `calc(25% + ${cloudsPosition.cloud2.y}px)`,
      ...
      <Image
        ...
        style={{
          ...
          top: `calc(20% + ${cloudsPosition.cloud4.y}px)`,
          width: "300px", // Make the cloud smaller
          transition: "transform 0.1s ease-out",
        }}
      />
      <Image
        ...
        style={{
          ...
          top: `calc(20% + ${cloudsPosition.cloud5.y}px)`,
          width: "300px", // Make the cloud smaller
