  ...
  return (
    <div className="absolute top-[-45%] left-[50%] w-[78rem] -translate-x-1/2 aspect-square">
      ...
      <Image
        ...
        className="absolute"
        style={{
          left: `calc(-10% + ${cloudsPosition.cloud1.x}px)`,
      ...
      <Image
        ...
        style={{
          ...
          top: `calc(90% + ${cloudsPosition.cloud3.y}px)`,
      ...
      <Image
        ...
        className="absolute"
        style={{
          left: `calc(-10% + ${cloudsPosition.cloud4.x}px)`,
          top: `calc(45% + ${cloudsPosition.cloud4.y}px)`,
          width: "300px", // Make the cloud smaller
          transition: "transform 0.1s ease-out",
        }}
      />
