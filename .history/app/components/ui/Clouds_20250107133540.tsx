    ...
    <div className="absolute top-[-45%] left-[50%] w-[78rem] -translate-x-1/2">
      <Image
        ...
        style={{
          ...
          top: `calc(10% + ${cloudsPosition.cloud1.y}px)`,
          width: "150px", // Make the cloud smaller
      ...
      <Image
        ...
        className="absolute"
        style={{
          left: `calc(50% + ${cloudsPosition.cloud2.x}px)`,
          top: `calc(50% + ${cloudsPosition.cloud2.y}px)`,
          transition: "transform 0.1s ease-out",
        }}
      />
      <Image
        ...
        className="absolute"
        style={{
          left: `calc(50% + ${cloudsPosition.cloud3.x}px)`,
          top: `calc(50% + ${cloudsPosition.cloud3.y}px)`,
          transition: "transform 0.1s ease-out",
        }}
      />
      <Image
        ...
        style={{
          ...
          top: `calc(50% + ${cloudsPosition.cloud4.y}px)`,
          transition: "transform 0.1s ease-out",
        }}
      />
      <Image
