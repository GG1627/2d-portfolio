  ...
  return (
    <div className="absolute top-[-45%] left-[50%] w-[78rem] -translate-x-1/2">
      <Image
        ...
        className="absolute"
        style={{
          right: `calc(17% + ${cloudsPosition.cloud1.x}px)`,
          bottom: `calc(50% + ${cloudsPosition.cloud1.y}px)`,
          width: "550px", // Make the cloud smaller
      ...
      <Image
        ...
        style={{
          ...
          top: `calc(15% + ${cloudsPosition.cloud2.y}px)`,
      ...
      <Image
        ...
        style={{
          ...
          top: `calc(100% + ${cloudsPosition.cloud3.y}px)`,
