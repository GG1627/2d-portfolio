...
const ParallaxClouds = () => {
  ...
  return (
    <div className="absolute top-[-40%] left-[50%] w-[78rem] -translate-x-1/2 aspect-square">
      <Circles />
      <Image
        src={Cloud1}
        alt="cloud 1"
        className="absolute"
        style={{
          left: `calc(-7% + ${cloudsPosition.cloud1.x}px)`,
          top: `calc(80% + ${cloudsPosition.cloud1.y}px)`,
      ...
      <Image
        ...
        className="absolute"
        style={{
          left: `calc(65% + ${cloudsPosition.cloud2.x}px)`,
      ...
      <Image
        ...
        className="absolute"
        style={{
          left: `calc(90% + ${cloudsPosition.cloud3.x}px)`,
          top: `calc(85% + ${cloudsPosition.cloud3.y}px)`,
          width: "300px", // Make the cloud smaller
          transition: "transform 0.1s ease-out",
        }}
      />
      <Image
        ...
        className="absolute"
        style={{
          left: `calc(-5% + ${cloudsPosition.cloud4.x}px)`,
          top: `calc(35% + ${cloudsPosition.cloud4.y}px)`,
          width: "300px", // Make the cloud smaller
          transition: "transform 0.1s ease-out",
        }}
      />
      <Image
        ...
        className="absolute"
        style={{
          left: `calc(80% + ${cloudsPosition.cloud5.x}px)`,
          top: `calc(60% + ${cloudsPosition.cloud5.y}px)`,
          width: "300px", // Make the cloud smaller
