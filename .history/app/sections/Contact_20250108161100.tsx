...
export const Contact = () => {
  return (
    <div
      className="w-full h-screen bg-[#0a0a0a] flex items-center justify-center py-12 px-6"
      id="Contact"
    >
      <div className="w-full max-w-screen-xl flex gap-16">
        <div className="flex flex-col w-1/2 text-white">
          <h2 className="text-7xl font-bold font-lexend mb-4">Get in Touch</h2>
          <p className="text-lg mb-6">
            I&apos;m always open to new opportunities and collaborations! Feel
            free to reach out to me for any projects, ideas, or just a friendly
            chat. Let&apos;s connect!
          </p>

          <div className="flex gap-8 mt-6">
            <a
              href="https://www.linkedin.com/in/gael-garcia1627/"
              target="_blank"
              rel="noopener noreferrer"
              className="p-4 bg-[#0077b5] text-white rounded-full hover:bg-[#e73f45] transition duration-300"
            >
              <FaLinkedin size={30} />
            </a>

            <a
              href="https://github.com/GG1627"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="w-1/2 bg-[#1d1d1d] p-8 rounded-lg shadow-lg">
          ...
          <form action="#" method="POST" className="space-y-6">
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                className="px-6 py-3 bg-[#5D97C9] text-white rounded-full text-lg hover:bg-[#ffffff] hover:text-[#0a0a0a] transition"
              >
                Send Message
              </button>
            </div>
