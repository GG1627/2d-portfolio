...
const About: React.FC = () => {
  ...
  return (
    <div className="h-screen flex flex-col md:flex-row items-center md:items-start p-6 bg-[#0a0a0a] text-white mt-20">
      {/* Left Section: Profile Picture */}
      <div className="flex-shrink-0 mb-6 md:mb-0 md:mr-8">
        <img
          src="/images/pic.jpg"
          alt="Gael's Picture"
          className="w-80 h-100 md:w-80 md:h-100 rounded-md object-cover shadow-lg"
        />
      </div>
