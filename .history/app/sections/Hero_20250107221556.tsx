...
export const Hero = () => {
  return (
    <div
      ...
      className="overflow-x-clip min-h-screen pb-12 flex items-center justify-center relative"
    >
      <div className="container mx-auto space-y-8 flex items-center justify-center flex-col text-center">
