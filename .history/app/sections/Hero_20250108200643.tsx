...
export const Hero = () => {
  return (
    <div
      ...
      className="overflow-x-clip min-h-screen pb-2 flex items-center justify-center relative scrollbar-hide"
      id="Home"
    >
      <div className="container mx-auto space-y-10 flex items-center justify-center flex-col text-center">
        ...
        <h1 className="text-blue-200 font-extrabold text-8xl">
          Hi, I&apos;m Gael!
        </h1>
