...
const projectsData = [
  ...
  },
  {
    ...
    description:
      "Collaborated on an open-source project to develop a Python plugin with the Manim library for animating and visualizing data structures, enhancing the understanding of complex algorithms.",
    image: "images/netflix.png",
    tag: ["All", "Web"],
    gitUrl: "/",
    previewUrl: "",
