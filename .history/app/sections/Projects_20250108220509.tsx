...
const projectsData = [
  {
    ...
    image: "images/three-portfolio.png",
    tag: ["All", "Web"],
    gitUrl: "https://github.com/GG1627/3d-portfolio",
    previewUrl: "https://3d-portfolio-one-hazel.vercel.app/",
    tools: [
      "TypeScript",
      "React",
      "React-Three-Fiber",
  ...
  },
  {
    ...
    tag: ["All", "Web"],
    gitUrl: "https://github.com/GG1627/2d-portfolio",
    previewUrl: "https://2d-portfolio-tau.vercel.app/",
    tools: [
      "TypeScript",
      "React",
      "Next.js",
...
export const Projects = () => {
  return (
    <>
      <h2
        className="text-center text-7xl font-bold mt-4 mb-10 font-lexend"
        id="Projects"
      >
        My Projects
      </h2>
