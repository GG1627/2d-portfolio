...
const About: React.FC = () => {
  ...
  return (
    <div className="h-screen flex flex-col md:flex-row p-6 bg-[#0a0a0a] text-white mt-20">
      ...
      <div className="bg-sky-400 bg-opacity-[10%] flex-grow md:basis-1/2 flex flex-col justify-center items-start p-8">
        {/* Greeting */}
        <h1 className="text-8xl font-bold mb-6">Hi, my name is Gael Garcia</h1>
